...
async function main() {
    ...
    try {
       ...
       // const res = await contract.evaluateTransaction('viewDocDetails',doctorId,patientId);
    
        const result = await contract.evaluateTransaction('getPatientHistory', patientId.toString());

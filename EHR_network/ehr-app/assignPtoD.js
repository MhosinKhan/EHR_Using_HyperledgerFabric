...
async function main() {
    ...
    try {
        ...
        let details = {
            ...
            patientId: 15,
            doctorName: 'Mr X',
            areaofExpertise: 'Diabetology',
            hospitalId: 100,
            hospitalName: 'City Hospital',
            consultIds: consultId
          }

        const issueResponse = await contract.submitTransaction('assignPatToDoc', JSON.stringify(details));

        // process response
        console.log('Transaction complete.' + issueResponse);

        const issueResponse1 = await contract.submitTransaction('editPatientDetails', JSON.stringify(details));

        console.log('Transaction complete.' + issueResponse1);  
